...
class HCollector (QtWidgets.QWidget):
    ...
    def __init__(self):
        ...
        geoLayout = QtWidgets.QHBoxLayout()
        imgLayout = QtWidgets.QHBoxLayout()
        dopLayout = QtWidgets.QHBoxLayout()
        customLayout = QtWidgets.QHBoxLayout()
        searchLay = QtWidgets.QHBoxLayout()
        checkLay = QtWidgets.QHBoxLayout()
        collectlay = QtWidgets.QVBoxLayout()

        self.grpB = QtWidgets.QGroupBox()
        self.grpB1= QtWidgets.QGroupBox()
        self.grpB2 = QtWidgets.QGroupBox()
        self.grpB3 = QtWidgets.QGroupBox()
        self.grpB4 = QtWidgets.QGroupBox()
  
        self.chFile = QtWidgets.QCheckBox('HipFile:')
        self.chGeo = QtWidgets.QCheckBox('Geometry:')
        self.chImg = QtWidgets.QCheckBox('Images:')
        self.chDop = QtWidgets.QCheckBox('Dop/Simulation:')
        self.chCustom = QtWidgets.QCheckBox('Custom:')
        self.ch_search = QtWidgets.QCheckBox('Search files:')
        self.chupd = QtWidgets.QCheckBox('Replace Old Files')
        self.charch = QtWidgets.QCheckBox('Create ZIP Archive')

        self.ln_file = QtWidgets.QLineEdit()
        self.ln_geo = QtWidgets.QLineEdit()
        self.ln_img = QtWidgets.QLineEdit()
        self.ln_dop = QtWidgets.QLineEdit()
        self.ln_attr = QtWidgets.QLineEdit()
        self.ln_customPath = QtWidgets.QLineEdit()
        self.ln_search = QtWidgets.QLineEdit() 
     
        self.btn_B_file = QtWidgets.QToolButton()   
        self.btn_B_geo = QtWidgets.QToolButton()
        self.btn_B_img = QtWidgets.QToolButton()
        self.btn_B_dop = QtWidgets.QToolButton()
        self.btn_B_custom = QtWidgets.QToolButton()
        self.btn_B_search = QtWidgets.QToolButton()
        self.btn_collect = QtWidgets.QPushButton()
    ...
    def setFilePath(self):
        ospath = QtWidgets.QFileDialog.getExistingDirectory(self, "Select Path to Save", os.path.dirname(hou.hipFile.path()))
